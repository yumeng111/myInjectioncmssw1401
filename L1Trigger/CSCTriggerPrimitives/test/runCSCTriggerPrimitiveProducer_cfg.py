...
process.source = cms.Source(
      "PoolSource",
      #eventsToProcess = cms.untracked.VEventRange('1:1017-1:1017'),
      #the line below only for several specific events (to append). To run full events, comment.
...
#only for 1 or more event
#process.source.eventsToProcess.append('1:3015-1:3015')
...
#l1csc.clctPhase1.clctHitPersist = cms.uint32(6)
#l1csc.clctPhase2.clctHitPersist = cms.uint32(6)
#l1csc.clctPhase2.clctPretriggerTriggerZone = cms.uint32(4)
print("CLCTphase1  parameters ", l1csc.clctPhase1, " phase2 ", l1csc.clctPhase2)
